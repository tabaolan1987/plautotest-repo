...
public class PLDailyTestCase9Test {
	...
	public void testPLDailyTestCase9() throws Exception {
		// Begin to load member BPF-0122398(active member)!
		System.out.println("Begin to load member BPF-0122398(active member)!");
		...
		selenium.click("//div[@id='menu' and @class='lefty']/ul//a[contains(text(),'My AA Statement')]");
		selenium.waitForPageToLoad("30000");
		Thread.sleep(60000);
		assertFalse(selenium.isTextPresent("[["));
		assertFalse(selenium.isTextPresent("]]"));
		...
		// Finish
		System.out.println("Loading member BPF-0122398(active member) PASS!");
		// ----------------------------------------
	}
