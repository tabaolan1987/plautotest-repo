...
public class PLDailyTestCase7Test {
	...
	public void testPLDailyTestCase7() throws Exception {
		...
		System.out.println("Begin to load #7 member BPF-0001341(Security lock-out in place)!");
		...
		// Finish
		System.out.println("Loading #7 member BPF-0001341(Security lock-out in place) PASS!");
		// ----------------------------------------
	}
