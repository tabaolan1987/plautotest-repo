...
public class PLDailyTestCase7Test {
	...
	@Test
	public void testPLDailyTestCase7() throws Exception {
		// Begin to load #7 member BPF-0001341(Security lock-out in place)!
		System.out.println("Case #7: Begin to load #7 member BPF-0001341(Security lock-out in place)!");
		try {
			...
			System.out.println("Case #7: Begin to load #7 member BPF-0001341(Security lock-out in place) PASS!");
			// May take a snapshot here
			TakeScreenShot.takeScreenshoot();
		} catch (SeleniumException se) {
			retried++;
			System.out.println("retried case7:" + retried);
			System.out.println(se.getMessage());
			if (retried < 5) {
				testPLDailyTestCase7();
			} else {
				System.out.println("Case #7: Begin to load #7 member BPF-0001341(Security lock-out in place) FAILURE!");
			}
		}
