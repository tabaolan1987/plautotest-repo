...
public class PLDailyTestCase7Test {
	...
	public void testPLDailyTestCase7() throws Exception {
		// Begin to load member BPF-0090597(Pensioner)!
		System.out.println("Begin to load member BPF-0090597(Pensioner)!");
		...
		// Finish
		System.out.println("Loading member BPF-0090597(Pensioner) PASS!");
		// ----------------------------------------
	}
