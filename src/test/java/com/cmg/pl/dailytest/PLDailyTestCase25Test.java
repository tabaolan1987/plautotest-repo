...
public class PLDailyTestCase25Test {
	...
	@Test
	public void testPLDailyTestCase25() throws Exception {
		...
		assertTrue(selenium.isElementPresent("link=Address"));
		...
		selenium.waitForPageToLoad("30000");
		System.out.println("BPGasActive-Update sth-PASSED");
	}
