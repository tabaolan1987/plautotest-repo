...
public class PLDailyTestCase23Test {
	...
	@Test
	public void testPLDailyTestCase23() throws Exception {
		selenium.open("/content/pl/_logout_confirm.html");
		selenium.click("link=Login");
		selenium.waitForPageToLoad("30000");
		selenium.type("id=_request_username", "bpgasactive2");
		...
		System.out.println("BPGasActive-MyDetails-PASSED");
	}
