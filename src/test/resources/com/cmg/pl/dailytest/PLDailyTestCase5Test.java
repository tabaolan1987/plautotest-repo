...
public class PLDailyTestCase5Test {
	...
	public void testPLDailyTestCase5() throws Exception {
		// Begin to load member BCF-0001532(Pensioner)!
		System.out.println("Begin to load member BCF-0001532(Pensioner)!");
		...
		// Finish
		System.out.println("Loading member BCF-0001532(Pensioner) PASS!");
		// ----------------------------------------
	}
