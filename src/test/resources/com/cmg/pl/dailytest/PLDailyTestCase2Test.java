...
public class PLDailyTestCase2Test {
	...
	public void testPLDailyTestCase2() throws Exception {
		// Begin to load member BPF-0058942(WALL'ed)!
		System.out.println("Begin to load member BPF-0059699(WALL'ed)!");
		...
		selenium.waitForPageToLoad("30000");
		Thread.sleep(8000);
		selenium.type("id=crefno", "0059295");
		selenium.click("id=doauth");
		Thread.sleep(8000);
		...
		// Finish
		System.out.println("Loading member BPF-0059295(WALL'ed) PASS!");
		// ----------------------------------------
	}
