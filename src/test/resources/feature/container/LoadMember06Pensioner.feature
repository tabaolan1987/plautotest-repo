Feature: daily test load member 06 pensioner
  ...
  Scenario: continue check this is me page
    ...
    And I should see the refno "0090597" existed in This is me page

  Scenario: continue check My benefits page
    Then I click to "My benefits" link
    Then I should see refno "0090597" existed in My benefits page
