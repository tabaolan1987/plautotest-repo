Feature: daily test load member 07 Security

  Scenario: check link under My details
    Given I open browser "firefox"
    And I navigate to Login Page
    Then I login as superuser
    Then I load member "BPF-0057437"
  ...
  Scenario: continue check this is me page
    ...
    And I should see the refno "0057437" existed in This is Me page
  ...
  Scenario: continue check Scheme benefits page
    ...
    Then I should see the refno "0057437" existed in Scheme benefits page
