Feature: daily test load member 03 deferred
  ...
  Scenario: check this is me page
    Then I click to "This is me" link
    Then I should see the refno "0001794" existed in This is Me page
    Then I logout
