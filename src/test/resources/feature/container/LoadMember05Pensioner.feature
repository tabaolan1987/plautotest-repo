Feature: daily test load member 05 pensioner
  ...
  Scenario: continue check this is me page
    ...
    And I should see the refno "0100027" existed in This is Me page

  Scenario: continue check My benefits page
    Then I click to "My benefits" link
    Then I should see refno "0100027" existed in My benefits page
